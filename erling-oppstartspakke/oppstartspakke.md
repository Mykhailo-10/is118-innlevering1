...
Det første møtet er et veldig viktig punkt i prosessen. Dette er basisen som resten av prosjektet kommer til å baseres på. Det første møtet er muligens første gang som deltagerne i gruppen møtes. Det er også veldig viktig at ledere i gruppen setter klare mål og frister for prosjektet fra dag en. Dette gjør at det ikke blir noen misforståelser senere i prosessen.  Det kan også være viktig å påpeke nøyaktige roller innad i gruppen. Dette kan gjøre at man slipper kluss med at noen gjør andre sine oppgaver.
 
Ved det første møtet er det noen ting som må være på agendaen. Det burde være noen form for teambygging. Småprat innad i gruppen kan være en god måte å skape gode relasjoner. «Gjennom småpraten danner de enkelte medlemmer seg et ganske rikt bilde av de andre» (Jacobsen, 2016). En god samarbeidsevne internt i gruppen er veldig viktig for at prosjektet skal gå så bra som mulig. Det er også veldig viktig at en ordentlig plan for prosjektet blir presentert av prosjektlederen. Dette hjelper resten av gruppen med å forstå hva arbeidsoppgaver er. Det kan også gjøre at eventuelle krav for prosjektet og frister fra prosjektleder kommer tydelig frem. Roller er også en viktig ting fra prosjektlederen å tildele under første møtet. Når roller blir tidlig tildelt, kan gruppen jobbe mer kontrollert og effektivt. Når roller ikke blir tildelt kan man oppleve at flere deltagere i gruppen gjør samme eller lignende arbeid, dette kan føre til sløsing av tid og ressurser. Under det første møtet er det også viktig at prosjektleder får kommunisert når de vil ha fremtidige møter og oppdateringer på prosjektet. Det er ikke veldig viktig å ha en fast timeplan med en gang her, men at prosjektleder kommer med en forventet timeplan for dette.
